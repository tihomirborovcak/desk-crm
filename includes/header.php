    ...
    <div class="app-container">
        ...
        <nav class="mobile-nav">
            ...
            <div class="nav-menu">
                ...
                <a href="upute.php" class="nav-item <?= $currentPage === 'upute' ? 'active' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="12" cy="12" r="10"/>
                ...
                <a href="facebook-post.php" class="nav-item <?= $currentPage === 'facebook-post' ? 'active' : '' ?>">
                ...
                <a href="facebook-messages.php" class="nav-item <?= $currentPage === 'facebook-messages' ? 'active' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="gmail-inbox.php" class="nav-item <?= in_array($currentPage, ['gmail-inbox', 'gmail-messages', 'gmail-setup', 'gmail-dashboard']) ? 'active' : '' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
